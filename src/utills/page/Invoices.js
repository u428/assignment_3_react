...
import {getAllInvoice} from '../../api/ApiHelper';
                    ...
                    <tbody>
                        {
                           invoices && invoices.map((invoice, ind)=>{
                               return(
                                   <>
                                   <tr>
                                   <td colSpan="4">On &nbsp;  <span className="bg-light h3">{invoice.date}</span> &nbsp; date amount is &nbsp; <span className="bg-warning h3">{invoice.invoice.amount}</span></td>
                                   </tr>
                                   {
